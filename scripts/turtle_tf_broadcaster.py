...
AMPLITUDE = 0.3      # радиус вращения вокруг черепашки (в метрах)
FREQUENCY = 24.0      # частота вращения (Гц)
...
def handle_turtle_pose(msg):
	...
	carrot_x = AMPLITUDE * math.cos(2 * math.pi * FREQUENCY * t)
	carrot_y = AMPLITUDE * math.sin(2 * math.pi * FREQUENCY * t)

	br.sendTransform(
		(carrot_x, carrot_y, 0.0),
